...
public final class AddressTest extends AbstractPhlocTestCase
{
  ...
  public void testDefaultImpl ()
  {
    ...
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (a, new Address ());
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (a, new Address (a, L_DE));
    PhlocTestUtils.testGetClone (a);

    a = new Address ();
    a.setType (EAddressType.PERSONAL);
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (a, new Address ());
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (a, new Address (a, L_DE));
    PhlocTestUtils.testGetClone (a);
