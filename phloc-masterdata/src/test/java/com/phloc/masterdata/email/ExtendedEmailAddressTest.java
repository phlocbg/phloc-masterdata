 ...
 */
public final class ExtendedEmailAddressTest extends AbstractPhlocTestCase
{
  @Test
  ...
  public void testDefaultImpl ()
  {
    ...
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (a, new ExtendedEmailAddress ());
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (a, new ExtendedEmailAddress (a));
    PhlocTestUtils.testGetClone (a);

    a = new ExtendedEmailAddress ();
    a.setType (EEmailAddressType.PERSONAL);
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (a, new ExtendedEmailAddress ());
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (a, new ExtendedEmailAddress (a));
    PhlocTestUtils.testGetClone (a);
