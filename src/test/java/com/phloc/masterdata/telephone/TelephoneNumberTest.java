 ...
 * @author philip
 */
public final class TelephoneNumberTest extends AbstractPhlocTestCase
{
  @Test
  ...
  public void testDefaultImpl ()
  {
    ...
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (a, new TelephoneNumber ());
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (a, new TelephoneNumber (a));
    PhlocTestUtils.testGetClone (a);

    a = new TelephoneNumber ();
    a.setType (ETelephoneType.PERSONAL);
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (a, new TelephoneNumber ());
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (a, new TelephoneNumber (a));
    PhlocTestUtils.testGetClone (a);
