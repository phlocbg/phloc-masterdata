...
import com.phloc.validation.validator.string.LongUnsignedValidator;
...
public final class LongUnsignedValidatorTest
{
  ...
  {
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (new LongUnsignedValidator (true),
                                                                    new LongUnsignedValidator (true));
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (new LongUnsignedValidator (false),
                                                                    new LongUnsignedValidator (false));
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (new LongUnsignedValidator (true),
                                                                        new LongUnsignedValidator (false));
  }
}
