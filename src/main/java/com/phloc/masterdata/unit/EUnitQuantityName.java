...
public enum EUnitQuantityName implements IHasDisplayText
{
  ...
  VOLUME_PER_TEMPERATURE ("volume per temperature", "volume per temperature"),
  VOLUME_RATIO ("volume ratio", "volume ratio"),
  TIME ("Zeit", "time"),
  ANGULAR_VELOCITY ("Winkelgeschwindigkeit", "angular velocity"),
  ANGULAR_ACCELERATION ("Winkelbeschleunigung", "angular acceleration"),
  VELOCITY_PHASE_VELOCITY_PLUS ("velocity, phase velocity, group velocity", "velocity, phase velocity, group velocity"),
  ACCELERATION_ACCELERATION_OF_FREE_FALL_PLUS ("acceleration, acceleration of free fall, acceleration due to gravity", "acceleration, acceleration of free fall, acceleration due to gravity"),
  CURVATURE ("Krümmung", "curvature"),
  FREQUENCY ("Frequenz", "frequency"),
  ROTATIONAL_FREQUENCY ("rotational frequency", "rotational frequency"),
  ANGULAR_FREQUENCY_PULSATANCE ("angular frequency, pulsatance", "angular frequency, pulsatance"),
  WAVELENGTH ("Wellenlänge", "wavelength"),
  WAVE_NUMBER_ATTENUATION_COEFFICIENT_PLUS ("wave number, attenuation coefficient, phase coefficient, propagation coefficient, repetency", "wave number, attenuation coefficient, phase coefficient, propagation coefficient, repetency"),
  ...
  DAMPING_COEFFICIENT ("damping coefficient", "damping coefficient"),
  LOGARITHMIC_DECREMENT ("logarithmic decrement", "logarithmic decrement"),
  MASS ("Masse", "mass"),
  DENSITY_MASS_DENSITY_PLUS ("density, mass density, volumic mass", "density, mass density, volumic mass"),
  RELATIVE_DENSITY_RELATIVE_MASS_DENSITY ("relative density, relative mass density", "relative density, relative mass density"),
  SPECIFIC_VOLUME_MASSIC_VOLUME ("specific volume, massic volume", "specific volume, massic volume"),
  LINEAR_DENSITY_LINEAR_MASS ("linear density, linear mass", "linear density, linear mass"),
  SURFACE_DENSITY_AREIC_MASS ("surface density, areic mass", "surface density, areic mass"),
  MOMENTUM ("Momentum", "momentum"),
  MOMENT_OF_MOMENTUM_ANGULAR_MOMENTUM ("moment of momentum, angular momentum", "moment of momentum, angular momentum"),
  MOMENT_OF_INERTIA_DYNAMIC_MOMENT_OF_INERTIA ("moment of inertia (dynamic moment of inertia)", "moment of inertia (dynamic moment of inertia)"),
  FORCE_WEIGHT ("force, weight", "force, weight"),
  FORCE_DIVIDED_BY_LENGTH ("force divided by length", "force divided by length"),
  GRAVITATIONAL_CONSTANT ("gravitational constant", "gravitational constant"),
  MOMENT_OF_FORCE_MOMENT_OF_A_COUPLE_PLUS ("moment of force, moment of a couple, torque", "moment of force, moment of a couple, torque"),
  IMPULSE ("Impuls", "impulse"),
  ANGULAR_IMPULSE ("Winkelimpuls", "angular impulse"),
  PRESSURE_NORMAL_STRESS_PLUS ("pressure, normal stress, shear stress, modulus of elasticity,shear modulus, modulus of rigidity, bulk modulus, modulus of compression", "pressure, normal stress, shear stress, modulus of elasticity,shear modulus, modulus of rigidity, bulk modulus, modulus of compression"),
  PRESSURE_RATIO ("pressure ratio", "pressure ratio"),
  LINEAR_STRAIN_RELATIVE_ELONGATION_PLUS ("linear strain, relative elongation, shear strain, volume or bulk strain", "linear strain, relative elongation, shear strain, volume or bulk strain"),
  POISSON_RATIO_POISSON_NUMBER ("poisson ratio, poisson number", "poisson ratio, poisson number"),
  COMPRESSIBILITY_BULK_COMPRESSIBILITY ("compressibility, bulk compressibility", "compressibility, bulk compressibility"),
  SECOND_MOMENT_OF_AREA_SECOND_AXIAL_MOMENT_OF_AREA ("second moment of area, second axial moment of area", "second moment of area, second axial moment of area"),
  SECOND_POLAR_MOMENT_OF_AREA ("second polar moment of area", "second polar moment of area"),
  SECTION_MODULUS ("section modulus", "section modulus"),
  FRICTION_FACTOR_COEFFICIENT_OF_FRICTION ("friction factor, coefficient of friction", "friction factor, coefficient of friction"),
  VISCOSITY_DYNAMIC_VISCOSITY ("viscosity (dynamic viscosity)", "viscosity (dynamic viscosity)"),
  KINEMATIC_VISCOSITY ("kinematic viscosity", "kinematic viscosity"),
  SURFACE_TENSION ("surface tension", "surface tension"),
  TORSIONAL_STIFFNESS_AREA_RELATED_TORSIONAL_MOMENT ("torsional stiffness, area-related torsional moment", "torsional stiffness, area-related torsional moment"),
  WORK_ENERGY_PLUS ("work, energy, potential energy, kinetic energy", "work, energy, potential energy, kinetic energy"),
  WORK_PER_UNIT_WEIGHT ("work per unit weight", "work per unit weight"),
  POWER ("power", "power"),
  MASS_FLOW_RATE ("mass flow rate", "mass flow rate"),
  MASS_RATIO ("mass ratio", "mass ratio"),
  VOLUME_FLOW_RATE ("volume flow rate", "volume flow rate"),
  LEAKAGE_RATE_OF_GAS ("leakage rate of gas", "leakage rate of gas"),
  THERMODYNAMIC ("thermodynamic", "thermodynamic"),
  TEMPERATURE ("temperature", "temperature"),
  FAHRENHEIT_TEMPERATURE ("fahrenheit temperature", "fahrenheit temperature"),
  TEMPERATURE_VARIATION_OVER_TIME ("temperature variation over time", "temperature variation over time"),
  ...
  REYNOLDS_NUMBER ("Reynolds number", "Reynolds number"),
  EULER_NUMBER ("Euler number", "Euler number"),
  FROUDE_NUMBER ("Froude number", "Froude number"),
  GRASHOF_NUMBER ("Grashof number", "Grashof number"),
  WEBER_NUMBER ("Weber number", "Weber number"),
  MACH_NUMBER ("Mach number", "Mach number"),
  KNUDSEN_NUMBER ("Knudsen number", "Knudsen number"),
  STROUHAL_NUMBER ("Strouhal number", "Strouhal number"),
  FOURIER_NUMBER ("Fourier number", "Fourier number"),
  PECLET_NUMBER ("Peclet number", "Peclet number"),
  RAYLEIGH_NUMBER ("Rayleigh number", "Rayleigh number"),
  NUSSELT_NUMBER ("Nusselt number", "Nusselt number"),
  STANTON_NUMBER ("Stanton number", "Stanton number"),
  ...
  PRANDTL_NUMBER ("Prandtl number", "Prandtl number"),
  SCHMIDT_NUMBER ("Schmidt number", "Schmidt number"),
  LEWIS_NUMBER ("Lewis number", "Lewis number"),
  MAGNETIC_REYNOLDS_NUMBER ("magnetic Reynolds number", "magnetic Reynolds number"),
  ALFVEN_NUMBER ("Alfven number", "Alfven number"),
  HARTMANN_NUMBER ("Hartmann number", "Hartmann number"),
  COWLING_NUMBER ("Cowling number", "Cowling number"),
  ...
  BRAGG_ANGLE ("Bragg angle", "Bragg angle"),
  ...
  FERMI_ENERGY ("Fermi energy", "Fermi energy"),
