...
public final class LongMinMaxValidatorTest
{
  ...
  {
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (new LongMinMaxValidator (0, 10),
                                                                    new LongMinMaxValidator (0, 10));
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (new LongMinMaxValidator (Long.MIN_VALUE, 10),
                                                                    new LongMinMaxValidator (Long.MIN_VALUE, 10));
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (new LongMinMaxValidator (0, Long.MAX_VALUE),
                                                                    new LongMinMaxValidator (0, Long.MAX_VALUE));
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (new LongMinMaxValidator (0, 1),
                                                                        new LongMinMaxValidator (0, 10));
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (new LongMinMaxValidator (0, 1),
                                                                        new LongMinMaxValidator (0, Long.MAX_VALUE));
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (new LongMinMaxValidator (0, 1),
