...
import com.phloc.validation.validator.string.DoubleMinMaxValidator;
...
public final class DoubleMinMaxValidatorTest
{
  ...
  {
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (new DoubleMinMaxValidator (0d, 10d),
                                                                    new DoubleMinMaxValidator (0d, 10d));
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (new DoubleMinMaxValidator (Double.NEGATIVE_INFINITY,
                                                                                               10d),
                                                                    new DoubleMinMaxValidator (Double.NEGATIVE_INFINITY,
                                                                                               10d));
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (new DoubleMinMaxValidator (0d,
                                                                                               Double.POSITIVE_INFINITY),
                                                                    new DoubleMinMaxValidator (0d,
                                                                                               Double.POSITIVE_INFINITY));
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (new DoubleMinMaxValidator (0d, 1d),
                                                                        new DoubleMinMaxValidator (0d, 10d));
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (new DoubleMinMaxValidator (0d, 1d),
                                                                        new DoubleMinMaxValidator (0d,
                                                                                                   Double.POSITIVE_INFINITY));
