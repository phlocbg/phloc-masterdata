...
public final class TimeValidatorConstantLocaleTest
{
  ...
  {
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (new TimeValidatorConstantLocale (Locale.GERMAN),
                                                                    new TimeValidatorConstantLocale (Locale.GERMAN));
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (new TimeValidatorConstantLocale (Locale.GERMAN),
